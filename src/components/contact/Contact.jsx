...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_8r56l9q", "template_aro3ept", form.current, {
        publicKey: "WLiWL10NlSfUawbKY",
      })
      .then(
        () => {
          setSuccess(true);
    ...
    >
      <motion.div className="container" variants={variants}>
        ...
        <motion.div className="form-container" variants={variants}>
          ...
          >
            <svg className="phone" viewBox="0 0 32.666 32.666">
              <motion.path
                strokeWidth={0.2}
                fill="none"
          ...
          >
            ...
            {success && (
              <span>
                Success with sending the email, we will response as soon as
                possible
              </span>
            )}
          </motion.form>
